...
--
-- Хост: 127.0.0.1
-- Время создания: Окт 13 2024 г., 01:46
...
(5, 'Панова Анастасия Евгеньевна', '1997-02-24', '8798 654789', '+7(921)345-25-36', 'ул.Гагарина д.14', 'IT отдел', 'Тестировщик', 100000, '2022-06-23', 'Работает'),
(6, 'Воробьева Анна Алексеевна', '2000-02-16', '8798 845785', '+7(921)345-32-89', 'ул.Колотушкина д.89', 'Кадров', 'Менеджер по персоналу', 80000, '2021-06-24', 'Работает');
